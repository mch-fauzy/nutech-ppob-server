 ...
 */
interface TransactionTopUpBalanceByEmailRequest extends TransactionOperationRequest {
    topUpAmount: number;
}
/**
...
export { TransactionBaseRequest, TransactionGetByEmailRequest, TransactionGetListByEmailRequest, TransactionOperationRequest, TransactionTopUpBalanceByEmailRequest, TransactionPaymentByEmailRequest, };
