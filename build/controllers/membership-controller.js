...
class MembershipController {
    static register = async ({ body }, res, next) => {
        try {
            ...
            const validatedRequest = await membership_dto_1.MembershipValidator.validateRegisterRequest(request);
            ...
            (0, response_1.responseWithDetails)(res, http_status_codes_1.StatusCodes.OK, constant_1.CONSTANT.INTERNAL_STATUS_CODE.SUCCESS, 'Register success', response);
        }
        catch (error) {
            next(error);
        }
    ...
    static login = async (req, res, next) => {
        try {
            ...
            const validatedRequest = await membership_dto_1.MembershipValidator.validateLoginRequest(request);
            const response = await membership_service_1.MembershipService.login({
                email: validatedRequest.email,
                password: validatedRequest.password,
            });
            (0, response_1.responseWithDetails)(res, http_status_codes_1.StatusCodes.OK, constant_1.CONSTANT.INTERNAL_STATUS_CODE.SUCCESS, 'Login success', response);
        }
        catch (error) {
            next(error);
        }
    ...
    static getProfileForCurrentUser = [
        ...
        async (req, res, next) => {
            try {
                ...
                const validatedRequest = await membership_dto_1.MembershipValidator.validateGetByEmailRequest(request);
                const response = await membership_service_1.MembershipService.getByEmail({
                    email: validatedRequest.email,
                });
                (0, response_1.responseWithDetails)(res, http_status_codes_1.StatusCodes.OK, constant_1.CONSTANT.INTERNAL_STATUS_CODE.SUCCESS, 'Get profile success', response);
            }
            catch (error) {
                next(error);
            }
    ...
    static updateProfileForCurrentUser = [
        ...
        async (req, res, next) => {
            try {
                ...
                const validatedRequest = await membership_dto_1.MembershipValidator.validateUpdateProfileByEmailRequest(request);
                ...
                (0, response_1.responseWithDetails)(res, http_status_codes_1.StatusCodes.OK, constant_1.CONSTANT.INTERNAL_STATUS_CODE.SUCCESS, 'Update profile success', response);
            }
            catch (error) {
                next(error);
            }
    ...
    static updateProfileImageForCurrentUser = [
        ...
        async (req, res, next) => {
            try {
                ...
                const validatedRequest = await membership_dto_1.MembershipValidator.validateUpdateProfileImageByEmailRequest(request);
                ...
                (0, response_1.responseWithDetails)(res, http_status_codes_1.StatusCodes.OK, constant_1.CONSTANT.INTERNAL_STATUS_CODE.SUCCESS, 'Update profile image success', response);
            }
            catch (error) {
                next(error);
            }
    ...
    static updateProfileImageCloudinaryForCurrentUser = [
        ...
        async (req, res, next) => {
            try {
                ...
                const validatedRequest = await membership_dto_1.MembershipValidator.validateUpdateProfileImageCloudinaryByEmailRequest(request);
