...
const handleGenericError = ({ operationName, error }) => {
    ...
    const message = constant_1.CONSTANT.ERROR_MESSAGE.UNRECOGNIZED;
    (0, logger_1.logError)({
        message,
        operationName,
        error,
...
const handleUnknownError = ({ operationName, error }) => {
    const referenceId = (0, uuid_1.v4)();
    const message = constant_1.CONSTANT.ERROR_MESSAGE.UNKNOWN;
...
const handlePrismaError = ({ operationName, error, }) => {
    ...
    (0, logger_1.logError)({
        message: constant_1.CONSTANT.ERROR_MESSAGE.UNRECOGNIZED,
        operationName,
        error,
        referenceId,
    });
    return failure_1.Failure.internalServer(`${constant_1.CONSTANT.ERROR_MESSAGE.UNRECOGNIZED}. Reference Id: ${referenceId}`);
};
/**
